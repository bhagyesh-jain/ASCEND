    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Rank = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SelectedTheme = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    EquippedTitle = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Achievements",
                columns: new[] { "AchievementId", "Description", "RequiredValue", "Title", "Type" },
                values: new object[,]
                {
                    { 1, "Complete a habit quest before 8:00 AM.", 1, "Early Riser", "EarlyRiser" },
                    { 2, "Achieve a 7-day habit streak.", 7, "Week Warrior", "Streak" },
                    { 3, "Achieve a 30-day habit streak.", 30, "Discipline Master", "Streak" },
                    { 4, "Achieve a 50-day habit streak.", 50, "Unstoppable", "Streak" },
                    { 5, "Complete 100 study sessions.", 100, "The Scholar", "CategoryStudy" },
                    { 6, "Complete 100 exercise sessions.", 100, "Iron Body", "CategoryExercise" }
                });
